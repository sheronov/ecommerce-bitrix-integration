module.exports = {
  title: 'Vue Storefront 2 for bitrix',
  base: '/',
  description: 'Documentation for the bitrix connector for Vue Storefront 2',
  head: [
  ...
  themeConfig: {
    repo: 'https://github.com/vuestorefront/bitrix',
    editLinks: true,
    docsDir: 'docs',
    docsBranch: 'develop',
    ...
    nav: [
      ...
      // { text: 'Demo', link: '' },
      { text: 'GitHub', link: 'https://github.com/vuestorefront/bitrix'},
      { text: 'Roadmap', link: 'https://github.com/vuestorefront/bitrix'}
    ],
    sidebar: [
      {
        title: 'Essentials',
