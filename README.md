...
```sh
grep -rl 'bitrix' ./ | xargs sed -i '' 's/bitrix/{YOUR INTEGRATION NAME}/g'
```
...
## Vue Storefront 2 integration with bitrix
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/bitrix.git
    cd bitrix
    ```
...
- [bitrix integration Documentation](https://docs.vuestorefront.io/bitrix)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `bitrix` channel on [our Discord](discord.vuestorefront.io).
